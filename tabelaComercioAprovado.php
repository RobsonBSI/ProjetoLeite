<?php
    ...
    if ($id_A) {
        ...
        // header("location:tabelaAprovado.php");
    }
?>
<!doctype html>
<html lang="pt-br">
            ...
            if (count($dados) > 0) {
                for ($i = 0; $i < count($dados); $i++) {
                    ...
                    <td>
                        ...
                        <a type="button" class="btn btn-outline-primary" href="editarComercio.php?id= <?php echo$dados[$i]['id'];?>"> Editar</a>
                        <a type="button" class="btn btn-outline-danger"  href="tabelaComercio.php?id= <?php echo $dados[$i]['id']; ?>">Excluir</a>
