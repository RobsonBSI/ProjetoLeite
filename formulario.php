...
<head>
    ...
    <script src="js/validatexte.js"></script>
    <script src="js/validaComercio.js"></script>
...
<nav class="leite">
    ...
    <div class="seleMenu">Selecione seu perfil:
        <div>
...
<div class="p2" hidden>
    <form method="post" action="" name="forComercio">
        ...
        <label for="produtoF" class="labelInput required">
        <input type="checkbox" name="aceita"> aceito o termo de uso: <a href="https://leiteorganico.cnpgl.embrapa.br/termouso.pdf" target="_blank" rel="noopener noreferrer"> (Termos de Uso)</a>
        </label>
        <label for="produtoF" class="labelInput required">
        <input type="checkbox" name="aceita1"> aceito a declaração de privacidade: <a href="https://leiteorganico.cnpgl.embrapa.br/declaracaoprivacidade.pdf" target="_blank" rel="noopener noreferrer"> (Declaração de Privacidade)</a>
        </label>
...
<script>
    ...
    $('#add_campo').click(function () {
        ...
        $('#formulario').append('<div class="form-group" id="campo' + cont + '"> <label class="labelInput ">Produtor: </label><input type="text" name="produtor1[]" class="inputUser" id="fornecedor"> <button type="button" id="' + cont + '" class="btn-apagar" style=" border: 2px solid #ff0000; background-color: white; padding: 0.4% 0.8%; font-size: 16px;"> - </button></div>');
    });
